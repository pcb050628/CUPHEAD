...
namespace me
{
	...
	void MainScene::Init()
	{
		...
		Texture* image_main_bg = ResourceManager::Load<Texture>(L"main_background", L"..\\content\\Scene\\main screen\\Main_Menu_Background.bmp");
		...
		Texture* image_select_main_bg = ResourceManager::Load<Texture>(L"select_main", L"..\\content\\Scene\\main screen\\selectPageBG.bmp");
		...
		Texture* image_select_red_bg = ResourceManager::Load<Texture>(L"select_red", L"..\\content\\Scene\\main screen\\selectPageBG_2.bmp");
		...
		smileSprite->SetImage(ResourceManager::Load<Texture>(L"mainscreen_smile_static", L"..\\content\\Scene\\main screen\\smile anim\\smile_1.bmp"));

		smileAnim = select_smile->AddComponent<Animator>(enums::eComponentType::Animator);
		smileAnim->AddAnim(*ResourceManager::Load<Animation>(L"mainscreen_smile", L"..\\content\\Scene\\main screen\\smile anim\\"));
