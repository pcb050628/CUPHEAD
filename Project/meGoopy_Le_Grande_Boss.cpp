...
#define PunchMaxDist 400
	...
	void Goopy_Le_Grande_Boss::Init()
	{
		...
		mMainAnimator->AddAnim(*ResourceManager::Load<Animation>(L"Goopy Le Grande_small_punch_back_L", L"..\\content\\BossFight\\Goopy Le Grande\\Phase 1\\Punch_L\\back\\"));
		mMainAnimator->AddAnim(*ResourceManager::Load<Animation>(L"Goopy Le Grande_small_punch_back_R", L"..\\content\\BossFight\\Goopy Le Grande\\Phase 1\\Punch_R\\back\\"));
		mMainAnimator->AddAnim(*ResourceManager::Load<Animation>(L"Goopy Le Grande_small_punch_stretch_L", L"..\\content\\BossFight\\Goopy Le Grande\\Phase 1\\Punch_L\\stretch\\"));
		mMainAnimator->AddAnim(*ResourceManager::Load<Animation>(L"Goopy Le Grande_small_punch_stretch_R", L"..\\content\\BossFight\\Goopy Le Grande\\Phase 1\\Punch_R\\stretch\\"));
		mMainAnimator->AddAnim(*ResourceManager::Load<Animation>(L"Goopy Le Grande_small_punch_end_L", L"..\\content\\BossFight\\Goopy Le Grande\\Phase 1\\Punch_L\\end\\"));
		mMainAnimator->AddAnim(*ResourceManager::Load<Animation>(L"Goopy Le Grande_small_punch_end_R", L"..\\content\\BossFight\\Goopy Le Grande\\Phase 1\\Punch_R\\end\\"));
		...
		mMainAnimator->AddAnim(*ResourceManager::Load<Animation>(L"Goopy Le Grande_big_punch_back_L", L"..\\content\\BossFight\\Goopy Le Grande\\Phase 2\\Punch_L\\back\\"));
		mMainAnimator->AddAnim(*ResourceManager::Load<Animation>(L"Goopy Le Grande_big_punch_back_R", L"..\\content\\BossFight\\Goopy Le Grande\\Phase 2\\Punch_R\\back\\"));
		mMainAnimator->AddAnim(*ResourceManager::Load<Animation>(L"Goopy Le Grande_big_punch_stretch_L", L"..\\content\\BossFight\\Goopy Le Grande\\Phase 2\\Punch_L\\stretch\\"));
		mMainAnimator->AddAnim(*ResourceManager::Load<Animation>(L"Goopy Le Grande_big_punch_stretch_R", L"..\\content\\BossFight\\Goopy Le Grande\\Phase 2\\Punch_R\\stretch\\"));
		mMainAnimator->AddAnim(*ResourceManager::Load<Animation>(L"Goopy Le Grande_big_punch_end_L", L"..\\content\\BossFight\\Goopy Le Grande\\Phase 2\\Punch_L\\end\\"));
		mMainAnimator->AddAnim(*ResourceManager::Load<Animation>(L"Goopy Le Grande_big_punch_end_R", L"..\\content\\BossFight\\Goopy Le Grande\\Phase 2\\Punch_R\\end\\"));
		...
		mMainAnimator->AddAnim(*ResourceManager::Load<Animation>(L"Goopy Le Grande_tomb_smash", L"..\\content\\BossFight\\Goopy Le Grande\\Phase 3\\Smash\\"));
		mMainAnimator->AddAnim(*ResourceManager::Load<Animation>(L"Goopy Le Grande_tomb_death", L"..\\content\\BossFight\\Goopy Le Grande\\Phase 3\\Death\\"));
