...
namespace me
{
	...
	void TitleScene::Init()
	{
		...
		SpriteRenderer* title_bg_sr = title_bg->AddComponent<SpriteRenderer>();
		...
		title_character->AddComponent<Animator>()->AddAnimation(L"..\\content\\title screen\\Cuphead and Mugman\\");
	}
